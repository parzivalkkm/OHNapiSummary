...
if sys.platform == 'win32':
    ...
    cmd = GHIDRA_DIR + '/support/analyzeHeadless.bat {} OHNapiSummary -import {} -postScript OHNapiSummary'
else:
    tee_template = '{} | tee {}'
    cmd = GHIDRA_DIR + '/support/analyzeHeadless {} OHNapiSummary -import "{}" -postScript OHNapiSummary'
